                                            ...
                                            <span style={{ lineHeight: "107%" }}>
                                                <span style={{ background: "white" }}>
                                                    <span style={{ letterSpacing: ".15pt" }}>
                                                        Sau kì nghỉ tết dài, mọi người lại tiếp tục
                                                        lao vào vòng quay của công việc. Để xóa tan
                                                        đi bầu không khí "u ám" dịp đi làm của năm
                                                        mới,
                                                        <strong> Galaxy Cinema</strong> chiêu đãi
                                                        các Stars mấy tác phẩm có thể coi là xịn xò
                                                        nè. Cùng tìm hiểu nha.
                                                    </span>
                                                </span>
                                            </span>
                                        </span>
