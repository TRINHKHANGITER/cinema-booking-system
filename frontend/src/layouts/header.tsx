                        ...
                        {isSignedIn ? (
                            ...
                            <>
                                <button
                                    ...
                                    className="ml-2 text-sm text-[#777] capitalize cursor-pointer transition-all duration-300 hover:text-[#f26b38]"
                                >
                                    Đăng nhập
                                </button>
                                            ...
                                            >
                                                <div className="grid grid-cols-4 gap-5">
                                                    ...
                                                    <div className="flex flex-col justify-between items-center gap-4">
                                                        ...
                                                        />
                                                        <h3 className="text-sm font-bold not-italic capitalize text-center">
                                                            Đăng Ký Thành Viên G-star Nhận Ngay Ưu
                                                            Đãi!
                                                        </h3>
                                                        <button
                                                            className="w-[96px] h-8 text-white border border-[#f58020] rounded text-[14px] font-bold not-italic bg-[#f58020] hover:text-white transition-all duration-300 ease-in-out focus:ring-1 focus:outline-none focus:ring-[#fb9440] capitalize cursor-pointer"
                                                            onClick={() => {
      ...
      <li className="py-1 text-sm hover:pl-1 hover:border-l-4 hover:border-[#fd841f] hover:bg-[#fb770b1a] transition-all">
        Phim IMAX
                            ...
                            <div className="pb-2">
                                ...
                                >
                                    <span
                                        className={`${openMenu === "phim" ? "text-[#F58020]" : ""} mr-2`}
                                    >
                                        Phim
                                    </span>
                        ...
                        <div className="pb-2">
                            ...
                            >
                                <span
                                    className={`${openMenu === "sukien" ? "text-[#F58020]" : ""} mr-2`}
                                >
                                    Sự kiện
                                </span>
                        ...
                        <div>
                            ...
                            >
                                <span
                                    className={`${openMenu === "rap" ? "text-[#F58020]" : ""} mr-2`}
                                >
                                    Rạp/Giá vé
                                </span>
