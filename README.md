...
- File seed đang `USE cinema_booking_system_test;`, nên nếu muốn import nguyên trạng thì hãy tạo database cùng tên, hoặc sửa lại tên database trong file trước khi import.
...
```powershell
$env:DATABASE_URL="jdbc:mysql://localhost:3306/cinema_booking_system_test?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=Asia/Ho_Chi_Minh"
