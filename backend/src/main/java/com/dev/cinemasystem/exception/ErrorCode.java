...
public enum ErrorCode {
    ...
    CINEMA_NAME_EXISTS("CINEMA_NAME_EXISTS", HttpStatus.BAD_REQUEST, "Cinema name already exists"),
    CINEMA_HAS_ACTIVE_ROOMS("CINEMA_HAS_ACTIVE_ROOMS", HttpStatus.BAD_REQUEST, "Cannot delete cinema because there are active rooms using it"),
    ...
    ROOM_TYPE_HAS_ACTIVE_ROOMS("ROOM_TYPE_HAS_ACTIVE_ROOMS", HttpStatus.BAD_REQUEST, "Cannot delete room type because there are active rooms using it"),
    ...
    MOVIE_NAME_EXISTS("MOVIE_NAME_EXISTS", HttpStatus.BAD_REQUEST, "Movie name already exists"),
    ...
    MOVIE_STATUS_BLANK("MOVIE_STATUS_BLANK", HttpStatus.BAD_REQUEST, "Movie status is required"),
    RELEASE_DATE_BLANK("RELEASE_DATE_BLANK", HttpStatus.BAD_REQUEST, "Release date is required"),
    END_DATE_BLANK("END_DATE_BLANK", HttpStatus.BAD_REQUEST, "End date is required"),
    MOVIE_END_DATE_INVALID("MOVIE_END_DATE_INVALID", HttpStatus.BAD_REQUEST, "endDate must be greater than or equal to releaseDate"),
    MOVIE_HAS_ACTIVE_SHOWTIMES("MOVIE_HAS_ACTIVE_SHOWTIMES", HttpStatus.BAD_REQUEST, "Cannot delete movie because there are active showtimes using it"),
    ...
    FILE_SIZE_EXCEEDED("FILE_SIZE_EXCEEDED", HttpStatus.PAYLOAD_TOO_LARGE, "Uploaded file exceeds allowed size"),
