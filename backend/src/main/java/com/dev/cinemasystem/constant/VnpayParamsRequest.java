package com.dev.cinemasystem.constant;
...
public class VnpayParamsRequest {
    ...
    public static final String TERMINAL_CODE = "vnp_TmnCode";
    ...
    public static final String ORDER_INFORMATION = "vnp_OrderInfo";
    ...
    public static final String TRANSACTION_REFERENCE = "vnp_TxnRef";
